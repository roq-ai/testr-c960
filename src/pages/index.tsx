  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Testr - Empowering you to share and control your PDFs. Upload, set expiry dates, and choose who gets access, even non-registered users. Communication and control in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Testr - Empowering you to share and control your PDFs. Upload, set expiry dates, and choose who gets access, even non-registered users. Communication and control in one place.`}
            </Text>
            <Box

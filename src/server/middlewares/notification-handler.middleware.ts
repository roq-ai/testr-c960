...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'product.update.update': { roles: ['owner', 'administrator'], key: 'product', tenantPath: [], userPath: [] },
  'discount.delete.delete': { roles: ['owner', 'administrator'], key: 'discount', tenantPath: [], userPath: [] },
};
